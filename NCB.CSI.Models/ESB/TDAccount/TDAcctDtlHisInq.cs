...
namespace NCB.CSI.Models.ESB.TDAccount {
    [Validator(typeof(TDAcctDtlHisInqValidator))]
    public class TDAcctDtlHisInqRq : EsbInqCommonRq {
    ...
    public class TDAcctDtlHisInqValidator : AbstractValidator<TDAcctDtlHisInqRq> {
        public TDAcctDtlHisInqValidator() {
    ...
    public class TDAcctDtlHisInqRs : EsbT24InqCommonRs {
        public IEnumerable<TDAcctDtlHisInqTDAcctRec> TDAcctRec { get; set; }
    }

    public class TDAcctDtlHisInqTDAcctRec {
        public string ArrngId { get; set; }
        public string CustPermId { get; set; }
        public string TDAcctNo { get; set; }
        public string CIFNo { get; set; }
        public IEnumerable<TDAcctDtlHisInqTDacctDtlInfo> TDacctDtlInfo { get; set; }
    }

    public class TDAcctDtlHisInqTDacctDtlInfo {
        public string CustEngName { get; set; }
        public string CustChnName { get; set; }
        public TDAcctDtlHisInqRsdntAddr RsdntAddr { get; set; }
    ...
    public class TDAcctDtlHisInqRsdntAddr {
