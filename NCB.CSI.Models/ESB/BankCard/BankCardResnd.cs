...
namespace NCB.CSI.Models.ESB.BankCard {
    [Validator(typeof(BankCardResndRqValidator))]
    public class BankCardResndRq : EsbRqServiceBody {
        ...
        public IEnumerable<BankCardResndDbAcctInfo> DbAcctInfo { get; set; }
        public IEnumerable<BankCardResndCrBankInfo> CrBankInfo { get; set; }
    ...
    public class BankCardResndDbAcctInfo {
        public string DbAcctNo { get; set; }
    }
    public class BankCardResndCrBankInfo {
        public string CrBankId { get; set; }
        public string CrAcctNo { get; set; }
    }
    public class BankCardResndRqValidator : AbstractValidator<BankCardResndRq> {
        public BankCardResndRqValidator() {
    ...
    public class BankCardResndRs : EsbNonT24CommonRs {
    }
}
